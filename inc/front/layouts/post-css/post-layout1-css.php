...
.ymc-smart-filter-container .container-posts .post-entry.post-layout1 .ymc-post-layout1 .read-more .btn {".$ymc_post_active_color."}
.ymc-smart-filter-container .ymc-pagination.pagination-default li a {".$ymc_post_text_color . $ymc_post_bg_color."}
.ymc-smart-filter-container .container-posts .post-entry.post-layout1 {".$ymc_post_font."}";
