...
.data-target-ymc".$c_target." .container-posts .post-entry .ymc-post-layout1 {".$ymc_post_bg_color."}
.data-target-ymc".$c_target." .container-posts .post-entry.post-layout1 .ymc-post-layout1 .read-more .btn {".$ymc_post_active_color."}
.data-target-ymc".$c_target." .ymc-pagination li a {".$ymc_post_text_color . $ymc_post_bg_color."}
.data-target-ymc".$c_target." .container-posts .post-entry.post-layout1 {".$ymc_post_font."}";
