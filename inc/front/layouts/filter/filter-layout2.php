...
$filter_css = ".ymc-smart-filter-container .filter-layout.filter-layout2 .filter-entry .filter-item .filter-link {". $ymc_filter_text_color . $ymc_filter_bg_color."}
               .ymc-smart-filter-container .filter-layout.filter-layout2 .filter-entry .filter-item .filter-link.active {".$ymc_filter_active_color."}
               .ymc-smart-filter-container .filter-layout.filter-layout2 .filter-entry .filter-item .filter-link {".$ymc_filter_font."}";
